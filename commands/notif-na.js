...
if (talkedRecently.has(message.guild.id)) {
  ...
  const m = await message.channel.send("<@&698208511514902618> qui veut jouer avec " + message.author.username);
...
console.log("La commande notif na a été utilisé par " + message.author.username + " sur le serveur " + message.guild + " dans le salon " + message.channel.name + " !")
}
module.exports.help = {
  name:"notif-na"
}
